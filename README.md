...
| 👁️ 观察期 | 一键进入观察期（固定 3 天，到期自动出关），紫色👁️卡片样式，支持提前出关 |
| ⭐ 等级显示 | 角色名右侧展示三角洲行动等级（取自 WeGame 角色数据，轮询时自动刷新）|
| 💰 资产展示 | 头像旁显示哈夫币与总资产估值（自动格式化万/亿）|
| 📋 战绩查询 | 卡片一键查看最近对局：撤离状态/盈亏/带出/击杀/藏品，支持烽火地带·全面战场·摸金潮三队列与分页 |
